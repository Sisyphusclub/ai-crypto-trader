...
export default function NewStrategyPage() {
  ...
  const [indicators, setIndicators] = useState<IndicatorConfig[]>([
    { type: 'EMA', period: 20, name: 'ema_fast' },
    { type: 'EMA', period: 50, name: 'ema_slow' },
  ...
  const [rules, setRules] = useState<TriggerRule[]>([
    {
      ...
      logic: 'AND',
      conditions: [
        { indicator: 'ema_fast', operator: 'crosses_above', compare_to: 'ema_slow' },
  ...
  const addRule = () => {
    setRules([
      ...rules,
      {
        side: 'long',
        logic: 'AND',
        conditions: [{ indicator: '', operator: '>', value: 0 }],
      },
    ])
  }
    ...
    <AppLayout locale={locale as string} mode="paper">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-display font-bold text-white">{t('newStrategy')}</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {indicators.map((ind, i) => (
                <div key={i} className="flex items-center gap-3 p-3 rounded-lg bg-white/5 flex-wrap">
                  ...
                  <button
                    ...
                    className="ml-auto text-danger hover:text-danger/80 transition"
                  >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="group relative">
                ...
                <input
                  ...
                  onChange={(e) => setTpAtrMultiplier(parseFloat(e.target.value) || 0)}
                  className="input-field w-full"
                  step="0.1"
                  min={0}
                />
              ...
              <div className="group relative">
                ...
                <input
                  ...
                  onChange={(e) => setSlAtrMultiplier(parseFloat(e.target.value) || 0)}
                  className="input-field w-full"
                  step="0.1"
                  min={0}
                />
          ...
          <div className="flex items-center justify-end gap-3">
            <Link href={`/${locale}/strategies`} className="btn-ghost">
              {tCommon('cancel')}
            </Link>
