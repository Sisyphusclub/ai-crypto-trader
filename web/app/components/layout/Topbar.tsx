  ...
  return (
    <header className="h-14 bg-surface-700/50 backdrop-blur-md border-b border-white/5 flex items-center justify-between px-6">
      <div className="flex items-center gap-4">
        ...
        {/* Search Bar */}
        <div className="hidden md:flex items-center gap-2 px-4 py-2 bg-surface-300/50 border border-white/5 rounded-lg w-64">
      ...
      <div className="flex items-center gap-3">
        {/* Notifications */}
        <button className="relative p-2 text-white/50 hover:text-white hover:bg-white/5 rounded-lg transition-all duration-200">
          ...
          <div ref={userRef} className="relative">
            ...
            >
              ...
              <div className="hidden sm:block text-left">
                ...
                <p className="text-[10px] text-white/40">Trader</p>
              </div>
